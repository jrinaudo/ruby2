...
class Assignment
  ...
  def create_user(args = {})
      User.create(username: args[:username], password_digest: args[:password_digest])
  end

  def create_todolist(args = {})
      TodoList.create(list_name: args[:name], list_due_date: args[:due_date])
  end
